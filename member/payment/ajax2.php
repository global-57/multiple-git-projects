...
if (isset($_REQUEST['action'])) {
	switch ($_REQUEST['action']) {
			...
			foreach ($boxes as $key => $value) {
				switch ($key) {
					case 'form':
							...
							<div name="udb" class="udb_box" id="udb'.$suffix.'">
								<div class="udb_signup_form" id="udb_signup_form'.$suffix.'">
									...
									<div style="overflow: hidden; height: 100%; margin-bottom: 10px;">
										<div style="width: 100%; float: left;">
											<div style="padding-right: 14px;">
												<input class="udb_input" type="hidden" id="name'.$suffix.'" placeholder="Enter your name (optional)" value="'.$name_pay.'" onfocus="if (this.value == \'Enter your name (optional)\') {this.value = \'\';}" onblur="if (this.value == \'\') {this.value = \'Enter your name (optional)\';}" title="Please enter your name." />
											</div>
										</div>
									</div>
									<div style="overflow: hidden; height: 100%;">
										<div style="width: 80%; float: left;">
											<div style="padding-right: 25px;">
												Email : <input required="required" class="udb_input" type="text" id="email'.$suffix.'" placeholder="Enter your e-mail (required)" value="'.$email_pay.'" onfocus="if (this.value == \'Enter your e-mail (required)\') {this.value = \'\';}" onblur="if (this.value == \'\') {this.value = \'Enter your e-mail (required)\';}" title="Please enter your e-mail." />
											</div>
										</div>
										<div style="width: 20%; float: left;">
											<div style="padding-right: 14px;">
												<input required="required" class="udb_input" placeholder="'.$campaign_details['currency'].'" type="hidden" id="amount'.$suffix.'" value="'.$amount_pay.'" onfocus="if (this.value == \''.$amount_pay.'\') {this.value = \'\';}" onblur="if (this.value == \'\') {this.value = \''.$amount_pay.'\';}" title="How much would you like to donate?" style="text-align: right;" />
											</div>
										</div>
									</div>' : '
									<div style="overflow: hidden; height: 100%; margin-bottom: 10px;">
									...
									<div style="overflow: hidden; height: 100%;">
										<div style="width: 80%; float: left;">
											<div style="padding-right: 25px;">
												<input class="udb_input" type="hidden" id="url'.$suffix.'" placeholder="Enter website URL (optional)" value="Enter website URL (optional)" onfocus="if (this.value == \'Enter website URL (optional)\') {this.value = \'\';}" onblur="if (this.value == \'\') {this.value = \'Enter website URL (optional)\';}" title="Please enter website URL." />
											</div>
										</div>
										<div style="width: 20%; float: left;">
											<div style="padding-right: 14px;">
												<input required="required" class="udb_input" placeholder="'.$amount_pay.'" type="hidden" id="amount'.$suffix.'" value="'.$amount_pay.'" onfocus="if (this.value == \''.$amount_pay.'\') {this.value = \'\';}" onblur="if (this.value == \'\') {this.value = \''.$amount_pay.'\';}" title="How much would you like to donate?" style="text-align: right;" />
											</div>
										</div>
									</div>');
						...
						} else $form = '<div class="udb_container"><div name="udb" class="udb_box"><div class="udb_confirmation_info" style="text-align: center;"><strong>Payment Gateway.</strong> Please check settings!</div></div></div>';
						$html .= $form;
						break;
		...
		case 'udb_submit':
			...
			if (!empty($return_url)) $return_url = base64_decode($return_url);
			$campaign_id = intval($_REQUEST['udb_id']);
			...
			if (!is_numeric($amount) || floatval($amount) < $campaign_details['min_amount']) {
				$error .= '<li>Payment amount must be at least '.number_format($campaign_details['min_amount'], 2, ".", "").' '.$campaign_details['currency'].'.</li>';
			}
			if (strlen($url) > 0) {
			...
			if ($payment_method == 'interkassa') {
				...
				if ($options['enable_authnet'] != 'on') $error .= '<li>Payment method not supported.</li>';
				$method = '
				...
				if ($options['enable_paypal'] != 'on') $error .= '<li>Payment method not supported.</li>';
				$method = '
...
<div class="udb_confirmation_info">
	...
	<div class="udb_signup_buttons">';
				if ($payment_method == 'bitpay') {
					$html .= '
		<input type="button" class="udb_submit" id="udb_bitpay'.$suffix.'" value="Confirm and Payment" onclick="udb_bitpay('.$donor_id.', \''.$amount.'\', \''.$email.'\', \''.$suffix.'\', \''.$return_url.'\');">
		<input type="button" class="udb_submit" id="udb_bitpay_edit'.$suffix.'" value="Edit Payment Method" onclick="udb_edit(\''.$suffix.'\');">
		<img id="udb_loading2'.$suffix.'" class="udb_loading" src="'.$url_base.'img/loading.gif" alt="">';
				} else if ($payment_method == 'stripe') {
					$html .= '
		<input type="button" class="udb_submit" id="udb_stripe'.$suffix.'" value="Confirm and Payment" onclick="udb_stripe('.$donor_id.', \''.$suffix.'\', \''.$return_url.'\');">
		<input type="button" class="udb_submit" id="udb_stripe_edit'.$suffix.'" value="Edit Payment Method" onclick="udb_edit(\''.$suffix.'\');">
		<img id="udb_loading2'.$suffix.'" class="udb_loading" src="'.$url_base.'img/loading.gif" alt="">';
				} else {
					$html .= '
		<input type="button" class="udb_submit" id="udb_signup_pay" value="Confirm and Payment" onclick="jQuery(\'#udb_pay'.$suffix.'\').click();">
		<input type="button" class="udb_submit" id="udb_signup_edit" value="Edit Payment Method" onclick="udb_edit(\''.$suffix.'\');">';
				}
				$html .= '
	</div>';
				if ($payment_method == 'interkassa') {
