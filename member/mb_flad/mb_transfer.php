...
<div class="d-flex justify-content-between align-items-center" >
	<div class="">
		<h5 class="mb-0">Transfer Balance </h5>
	</div>
	
</div>
<p class="mb-0"> Please enter detail transfer you want<br /><font style="font-size:12px; color:#FC3;"><i>Min <?php echo rupiah($mintranswalletcash); ?>, Max <?php echo rupiah($maxtranswalletcash); ?>, Fee <?php echo $feetranswalletcash; ?>%.</i></font></p> 	
<hr>
