...
<h5 class="mb-0">Payment Deposit </h5>
<p> Make sure to send to the registered account number, <a class="btn btn-dark btn-sm" href="index.php?go=deposit" style="margin-top:10px;"> Back To Deposit History </a>  </p> 
<hr>
...
<input type="hidden" id="amount" name="amount" value="<?php echo $bayare; ?>"/>
		...
		<span> Trx </span> 
		<input type="text" readonly disabled="true"  class="form-control db"  value="<?php echo $sc; ?>" placeholder=""    />
		<span> Total Deposit </span> 
		<input type="text" readonly disabled="true"  class="form-control db"  value="<?= $jumlahdepone; ?>" placeholder=""    />
