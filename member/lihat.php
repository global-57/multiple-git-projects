...
//if($freenyac == 1){  
//$dbasewaletec="dataswalet";
//else{
$dbasewaletec="datacwalet";
//}
...
function myfunction() {
    ...
    if (x.style.display === 'none') {
        ...
        x.style.display = 'none';
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Stake [<?php echo $kodestake;?>]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:;" data-click="panel-remove" onclick="myfunction()"><button type="button" class="btn btn-danger btn btn-xs" style="margin-top:15px;">Close</button></a></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
  ...
  <script type="text/javascript" src="assets/js/functions.js"></script>
   ...
   <script>
        ...
        <h4 style="color:#B70000; margin-top:-10px; font-weight:bold;"><div class="demo4"></div></h4> 
        <div id="submit<?php echo $id; ?>"><button type="button" class="btn btn-success btn" style="margin-top:15px;"><i class="fa fa-refresh"></i>&nbsp;Reload</button></div>
       <script> 
$('#submit<?php echo $id; ?>').click(function(event){ 
   $("#div_element").load('lihat.php?id=<?php echo $id; ?>');  
