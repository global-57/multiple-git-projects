...
<h5 class="mb-0">Enter Dashboard </h5>
<p> Please Enter Your User ID And Password Correctly </p> 
<hr>
...
<div class="div-card bg-2">	
	...
	<input name="passlogin" required type="password"  class="form-control" placeholder="Your Password" style="background:#161616; border:none;">
