...
<head>
    ...
    <link rel="stylesheet" href="../css/sweetalert.css">
        ...
        <script type="text/javascript" src="../themes/assets/highslide/highslide-with-gallery.js"></script>
<script type="text/javascript" src="../themes/assets/highslide/highslide-with-html.js"></script>
<link rel="stylesheet" type="text/css" href="../themes/assets/highslide/highslide.css" />
    <script type="text/javascript">
	hs.graphicsDir = '../themes/assets/highslide/graphics/';
...
$saldocwalete = $db->myswalet($user_session);
			 ...
			 $totalcwaletec = "<a href='index.php?toreal' style='color:#F9A8A9;' title='Free Balance - Change to Real Balance'>".balance($saldocwalete-$pendingcwalete)."</a>"; 
			 $totalcwaletec2 = "<a href='index.php?toreal' title='Free Balance - Change to Real Balance'><i class='material-icons' style='color:#F9A8A9;'>refresh</i></a>"; 
...
$saldocwalete = $db->mycwalet($user_session);
			 ...
			 $totalcwalete = $saldocwalete-$pendingcwalete; 
			 $totalcwaletec = "<a href='index.php?tofree' style='color:#54F6A3;' title='Real Balance - Change to Free Balance'>".balance($saldocwalete-$pendingcwalete)."</a>"; 
			 $totalcwaletec2 = "<a href='index.php?tofree' title='Real Balance - Change to Free Balance'><i class='material-icons' style='color:#54F6A3;'>refresh</i></a>"; 
            ...
            <header>
                <div class="container h-100">
                    <div class="flex-header">
                        ...
                        <div class="h-menu" align="right"><a class="menu-toggle" href="#" style="color: #343A40;"><i class="la la-bars"></i></a></div>
                    </div>
                </div>
            </header>
	...
	<div class="mainmenu">
		  ...
		  <?php 
			 ...
			 $dirfotopro = "./images/".$fotokupro."";
				   ...
				   $fotoprofilku = "<img style='max-height:70px;'  src='".$dirfotopro."'>";
				   $fotoprofilkux = "./images/".$fotokupro."";
				   }else {
				   $fotoprofilku = "<img style='max-height:70px;'  src='../images/profile2.png'>";
				   $fotoprofilkux = "../assets_landing/img/profile.svg'";
				   } ?>
		...
		<div class="footer-flex">
			...
			<a class="footer-menu-flex"  href="index.php?go=blogs">
			 ...
			 <a class="footer-menu-flex" href="index.php?go=profile">
				<div class="footer-menu-flex-2 special-main" align="center"><img class="special" src="../images/profile.png" width="60" height="60"><span>Profile</span></div>
			</a>
