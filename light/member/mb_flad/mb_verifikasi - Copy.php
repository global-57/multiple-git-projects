 ...
 <!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Know Your Customer (KYC)</li>
      </ol>
    </section>
...
<div class="row">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Send Verification</h3>
            </div>
            <div class="box-body">    
...
if($rowcaa["acc"]== 1){ ?>
        <div class='alert alert-success alert-dismissable'>Verified <?php echo $tglaccne;?></div>
          
   <?php } else {
	echo "<div class='alert alert-info alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'></button>You have sent verification, please wait, we will process your verification as soon as possible.</div>";
   }
	?>      
        <?php } else{ ?>                
...
echo "<div class='alert alert-success alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'></button>This verification has been sent before!</div>";
}
?>  
<?php
 if(isset($_GET['result'])&&$_GET['result']=="error"){
echo "<div class='alert alert-danger alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'></button>You have sent verification before.</div>";
}
?> 
 <?php
 if(isset($_GET['result'])&&$_GET['result']=="size1_error"){
echo "<div class='alert alert-danger alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'></button>Upload Identity card file maximum size of 1MB</div>";
}
?> 
 <?php
 if(isset($_GET['result'])&&$_GET['result']=="size2_error"){
echo "<div class='alert alert-danger alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'></button>Upload full body photo maximum size of 1MB</div>";
}
?>  
<?php
 if(isset($_GET['result'])&&$_GET['result']=="file1_error"){
echo "<div class='alert alert-danger alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'></button>Upload Identity card only file jpg, png or gif.</div>";
}
?> 
<?php
 if(isset($_GET['result'])&&$_GET['result']=="file2_error"){
echo "<div class='alert alert-danger alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'></button>Upload full body photo only file jpg, png or gif.</div>";
}
?> 
<?php
 if(isset($_GET['result'])&&$_GET['result']=="file1_error2"){
echo "<div class='alert alert-danger alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'></button>Identity card photo is not valid.</div>";
}
?>              
<?php
 if(isset($_GET['result'])&&$_GET['result']=="file2_error2"){
echo "<div class='alert alert-danger alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'></button>Full body photo is not valid.</div>";
}
?> 
 <?php
 if(isset($_GET['result'])&&$_GET['result']=="err"){
$mx = $_GET['mx'];
echo "<div class='alert alert-danger alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'></button>This confirmation has been sent before.</div>";
}
?>

<?php
 if(isset($_GET['result'])&&$_GET['result']=="success"){
echo "<div class='alert alert-success alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'></button>Verification was sent successfully, (No ".$_GET['co'].") , please wait, we will process your verification as soon as possible.</div>";
}
?>
...
<div class="input-group">
                   <span class="input-group-addon" id="basic-addon1"><i class="fa fa-id-badge" aria-hidden="true"></i>
</span>
            <input name="nama" type="text" class="form-control" id="nama" required='required' value="<?php echo $_SESSION["nama"];?>">
          ...
          <div class="controls-row" style="margin-top:10px;">
            ...
            <label>Address</label>
<div class="input-group">
                   <span class="input-group-addon" id="basic-addon1"><i class="fa fa-map-marker" aria-hidden="true"></i>
</span>
           <input name="alamat" type="text" class="form-control" id="alamat" required='required' value="<?php echo $_SESSION["alamat"];?>">
 ...
 <div class="input-group">
<input type="text" id="filename" class="form-control" style="width:50%;">
<span class="input-group-btn"><input type="button" value="Select File" onclick="document.getElementById('uploadfile').click()" class="btn btn-info">  
 ...
 <div class="input-group">
<input type="text" id="filename2" class="form-control" style="width:50%;">
<span class="input-group-btn"><input type="button" value="Select File" onclick="document.getElementById('uploadfile2').click()" class="btn btn-info">  
 ...
 <div>
          ...
          <div>
            ...
            <input type="submit" value="Send Verification" class="btn btn-<?php echo $buttone; ?>"  name="submitv">

          </div>

        </form>   
      <br />    
<br /><i>Upload only file jpg, png, gif. Max size upload 1 MB.</i>
