...
<div class="d-flex justify-content-between align-items-center" >
	<div class="">
		<h5 class="mb-0" style="color:#666666;">Form Deposit </h5>
	</div>
...
<p class="mb-0" style="color:#666666;"> Please enter the nominal deposit you want<br /><font style="font-size:12px; color:#666666;"><i>Min <?php echo rupiah($minimalbuywalletcash); ?>, Max <?php echo rupiah($maksimalbuywalletcash); ?>, Fee <?php echo $feebuywalletcash; ?>%.</i></font></p> 	
<hr>
	...
	$db->select("kode, uraian, username, jumlah, tujuan, tgl, status, tglproses, jenis", "datacwalet2", "username='$user_session'", "tgl desc");
		...
		while($row=$db->fetch_row()) {
			...
			if($row[6] > 0) {
				...
				$st = "<b  style='color: orange' > Waiting Payment </b>";
