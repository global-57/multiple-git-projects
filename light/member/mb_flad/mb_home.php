...
<div class="binance-widget-marquee" data-cmc-ids="1,1027,1839,3408,52,74,5426,3890,5805,7083,2010,6636" data-theme="light" data-transparent="true" data-locale="en" data-powered-by="Powered by" data-disclaimer="Disclaimer" >
</div>
<?php } ?>
...
<h6 class="mt-3" style="color:#666666;">History</h6>
<div style="height:350px; overflow:auto; margin-bottom:30px;">
  <table id="examplex" width="100%" style="font-size:14px;color:#666666;">
...
<h6 class="mt-3" style="color:#666666;">Coin Charts</h6>
<div class="div-card bg-2 flex-vertical">	
	<script defer src="https://www.livecoinwatch.com/static/lcw-widget.js"></script> 
	<div class="livecoinwatch-widget-1" lcw-coin="BTC" lcw-base="USD" lcw-secondary="BTC" lcw-period="d" lcw-color-tx="#333333" lcw-color-pr="#58c7c5" lcw-color-bg="#ffffff" lcw-border-w="1" >
	</div>

	<div class="livecoinwatch-widget-1" lcw-coin="ETH" lcw-base="USD" lcw-secondary="BTC" lcw-period="d" lcw-color-tx="#333333" lcw-color-pr="#58c7c5" lcw-color-bg="#ffffff" lcw-border-w="1" >
	</div>
	<div class="livecoinwatch-widget-1" lcw-coin="LTC" lcw-base="USD" lcw-secondary="BTC" lcw-period="d" lcw-color-tx="#333333" lcw-color-pr="#58c7c5" lcw-color-bg="#ffffff" lcw-border-w="1" >
	</div>
...
<h6 class="mt-3" style="color:#666666;">Realtime Forex</h6>
<div class="div-card">
...
<h6 class="mt-3" style="color:#666666;">Recomended Coin</h6>
