...
<div class="d-flex justify-content-between align-items-center" >
	<div class="">
		<h5 class="mb-0" style="color:#666666;">Know Your Customer (KYC) </h5>
	</div>

</div>
<p class="mb-0" style="color:#666666;"> Please complete the verification form below and send it to get full access to your account</p> 	
<hr>
