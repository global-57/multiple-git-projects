...
?>
  ...
  <tr class="<?php echo $class; ?>">
    ...
    <td align="center">
     <?php if($demomode == 1){ ?>
      <a href="#" onClick='return confirmActiondemomode()' style='cursor:hand'><img src='images/icon-32-delete_resize.png' border=0 title='Click to Hapus'></a>
      <?php } else { ?>
       <a href="#" onClick='confirmation(<?php echo $db->result($i, "id"); ?>)' style='cursor:hand'><img src='images/icon-32-delete_resize.png' border=0 title='Click to Hapus'></a>
            <?php } ?>
    </td>
  </tr>
<?php
