                    ...
                    <div class="flex-header">
                        ...
                        <div class="h-info">
                            <div class="info-balance">
								...
								<span><?php echo balance(0); ?><strong> - Not Login</strong></span>
							</div>
                        </div>
                        <div class="h-menu" align="right"><a class="menu-toggle" href="#" style="color: #888888;"><i class="la la-bars"></i></a></div>
                    </div>
                </div>
            </header>
...
<div class="mainmenuel" ondblclick="toggleMenu();" align="right">
	<div class="mainmenu">
			...
			<div class="mainmenu-login" align="left">
				...
				<p class="fs-14">Please enter Username and Password correctly</p>
				<hr>
				<input name="userlogin" type="text" placeholder="Username / Email">
