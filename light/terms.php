...
<head>
	...
	<title>Terms - <?php echo WEB_TITLE; ?></title>
...
<?php
$sqlc = mysql_query("SELECT * FROM content WHERE  published=1 and catid=50");
...
<div class=""  style="border-radius:10px; overflow:hidden " >
	...
	<h4 class="m-0" style="color:#666666;">Terms and Conditions</h4> 
<hr>
					
				<div class="pt-2">
	<p style="color:#666666;"><?php echo $data;?></p> 
    
                    <p><?php if($regpublic == 1){ ?><a href="signup.php" class="btn btn-dark form-control">Register Now</a><?php } ?></p>    
	</div>
