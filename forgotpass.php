...
<p> Please Enter detail to reset password </p> 
<hr>
...
<div class="div-card bg-2">	
	...
	<input name="email" required type="email"  class="form-control" placeholder="Email address" style="background:#161616; border:none;">
